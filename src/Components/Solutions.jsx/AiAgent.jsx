  ...
  const agents = [
    {
      ...
      points: [
        ...
        "Answers questions,captures leads",
    ...
    },
    {
      ...
      points: [
        ...
        "Qualifies callers professionally",
        "Books and routes appointments",
  ...
  return (
    <section className="relative bg-linear-to-br from-white via-cyan-50/30 to-white overflow-hidden mt-10 pb-20">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        variants={fadeUp}
        className="relative w-full bg-white py-10 md:py-20 px-4 overflow-hidden"
      >
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-0">
            <motion.div variants={fadeUp} className="lg:w-1/4 flex justify-center lg:justify-start">
            ...
            <motion.div variants={fadeUp} className="lg:w-2/4 text-center flex flex-col items-center">
              ...
              <p className="text-gray-500 text-sm md:text-lg max-w-xl mx-auto mt-8 md:mt-10 leading-relaxed font-medium">
                AI-driven tools to accelerate your business, transform ideas into visuals, and create stunning digital
                experiences effortlessly.
              </p>

              <motion.div whileHover={{ scale: 1.05 }} className="mt-8 md:mt-10">
            ...
            <motion.div variants={fadeUp} className="lg:w-1/4 flex flex-col items-center text-center md:pl-35">
      ...
      {/* Middle Section */}
      <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeIn} className="relative mt-8">
        <div className="absolute inset-0 flex justify-center items-center overflow-hidden pointer-events-none top-[30%] md:top-[45%]"
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6">
          <div className="flex justify-between items-start mb-6 max-w-4xl mx-auto">
            <motion.div whileHover={{ y: -5, scale: 1.02 }} className="hidden sm:block bg-blue-50 border border-blue-100 px-4 py-3 items-center rounded-xl shadow-sm">
            ...
            <motion.div whileHover={{ y: -5, scale: 1.02 }} className="hidden sm:block bg-blue-50 border border-blue-100 px-4 py-3 rounded-xl shadow-sm">
              <div className="flex items-center space-x-2">
                <div className="bg-blue-500 text-white p-1.5 rounded-full">
                  <Mic size={16} />
                </div>
                <p className="font-semibold text-blue-900 text-sm">AI Voice Agent</p>
              </div>
            </motion.div>
          </div>

          <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1, transition: { duration: 0.8, ease: "easeOut" } }} className="flex justify-center my-8">
          ...
          <motion.div variants={fadeUp} className="flex justify-between items-end max-w-5xl mx-auto">
            <div className="text-left max-w-xs">
              <p className="text-gray-600 text-sm leading-relaxed">
                Connect every part of your workflow with intelligent automation instantly.
              </p>
            </div>
            <div className="text-right">
              <p className="font-semibold text-base md:text-lg">Optimized for Speed.</p>
      ...
      <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="max-w-6xl mx-auto px-6 mt-20 grid lg:grid-cols-2 gap-10 items-center">
        <div>
        ...
        <div className="relative w-87.5 sm:w-100 h-87.5 mx-auto">
          <motion.div whileHover={{ rotate: -5, y: -10, scale: 1.05 }} transition={{ type: "spring", stiffness: 150 }} className="absolute top-16 left-0 bg-white shadow-xl rounded-xl rotate-[-4deg] w-64 z-20">
            <img src={card1} alt="coffee" className="rounded-xl" />
          </motion.div>

          <motion.div whileHover={{ rotate: 5, y: -10, scale: 1.05 }} transition={{ type: "spring", stiffness: 150 }} className="absolute top-0 right-1 bg-white shadow-2xl rounded-xl rotate-6 w-64 z-10">
      ...
      {/* Agent Cards */}
      <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="mt-20 flex items-center justify-center p-8">
        <div className="max-w-6xl w-full">
          <div className="text-center mb-16">
            <h1 className="text-5xl font-bold text-gray-900 mb-4">Agent Types</h1>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Unlock a suite of intelligent tools designed to elevate your business and bring your clients at your doorstep.
            </p>
          </div>
