...
import image2 from '../../assets/Sales/image2.png';
import image3 from '../../assets/Sales/image3.png';
      ...
      >
        <div className='flex flex-col md:flex-row relative items-center justify-evenly space-y-12 md:space-y-0'>
          ...
          <div className='flex items-center gap-3 sm:gap-5'>
            <div>
              <img className='hidden sm:block w-16 sm:w-24 md:w-30' src={aiHand} alt="" />
            </div>
            <div className='hidden sm:block space-y-2 sm:space-y-4 text-center md:text-left'>
          ...
          <div className='absolute'>
            <motion.img
              ...
              className='w-60 sm:w-90 md:w-150'
              src={smartPhone}
              alt=""
            />
          </div>
          ...
          <div className='relative flex flex-col sm:flex-row items-center pl-40 md:pl-18 pb-30'>
            <div className='flex items-center mb-6 mb-30 md:mb-50'>
              ...
              <div className='space-y-4 ml-4 sm:space-y-10 sm:ml-8 md:space-y-15 md:ml-10'>
                <motion.img
                  ...
                  src={image2}
                  alt=""
                  className='w-8 h-8 sm:w-12 sm:h-12 md:w-15 md:h-15 rounded-full'
                />
                <motion.img
                  variants={fadeUp}
                  src={image3}
        ...
        {/* Floating Smart Automation Card */}
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.8, ease: "easeOut" }}
          className='absolute hidden sm:block left-1/2 md:left-[72%] top-[80%] md:top-[60%] transform -translate-x-1/2 z-20 bg-blue-100 p-5 sm:p-6 md:p-8 space-y-5 rounded-2xl shadow-lg w-64 sm:w-72 md:w-80 text-center'
        >
