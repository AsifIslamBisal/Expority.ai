    ...
    return (
        <section>
            ...
            <div className="min-h-screen bg-linear-to-br from-white via-cyan-50/30 to-white p-8 md:p-16 font-sans overflow-hidden mt-10">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <motion.div 
                        ...
                        className="lg:col-span-6 flex flex-col min-h-[85vh] justify-between"
                    >
                        <div className="space-y-10">
                            ...
                            <motion.div whileHover={{ scale: 1.05 }} className="inline-flex items-center gap-2 px-5 py-2.5 border border-gray-200 rounded-full text-gray-500 bg-white shadow-sm w-fit">
                                <PiRainbowThin />
                        ...
                        <div className="mt-32 flex flex-col md:flex-row md:items-end gap-12 mb-8">
                            ...
                            <div className="flex flex-col gap-5 md:max-w-sm">
                                <h3 className="text-4xl font-semibold text-gray-800 leading-[1.1] max-w-[320px] md:max-w-[350px]">Client Acquisition has never been easy before!</h3>
                                <p className="text-gray-500 text-base leading-relaxed">Our AI solutions streamline lead capture, automate follow-ups, and schedule appointments—helping you win and retain clients effortlessly.</p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    <div className="lg:col-span-6 relative flex items-start justify-center lg:justify-end gap-2 pt-10">
                        <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 1 }} className="relative mt-44"> 
                            <div className="absolute -top-36 left-0 flex flex-col items-end gap-3 z-20 w-full">
                                <div className="bg-white hover:bg-blue-600 hover:text-white border border-gray-100 px-6 py-2.5 rounded-full text-[13px] font-medium text-gray-600 shadow-md transition-colors">Smart Automation</div>
                                <div className="flex gap-2">
                                    <div className="bg-white hover:bg-blue-600 hover:text-white border border-gray-100 px-5 py-2.5 rounded-full text-[13px] font-medium text-gray-600 shadow-md transition-colors">Fully cust</div>
                                    <div className="bg-white hover:bg-blue-600 hover:text-white px-5 py-2.5 rounded-full text-[13px] font-medium text-gray-600 shadow-md transition-colors">Client Onboard</div>
                                </div>
                            </div>
            ...
            <section className="bg-white py-16 px-8 md:px-24 font-sans text-gray-900">
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInScroll} className="flex flex-col md:flex-row justify-between items-start mb-16">
                    <div>
                    ...
                    <div className="mt-8 md:mt-0 max-w-md">
                        <div className="flex flex-wrap gap-3 mb-6">
                            {['Leads', 'Client Follow-up', 'Schedule'].map((btn) => (
                                <button key={btn} className="px-6 py-2 hover:bg-blue-600 border border-gray-300 hover:text-white rounded-full text-sm transition-all">{btn}</button>
                            ))}
                        </div>
                        <p className="text-gray-500 leading-relaxed">We capture and qualify leads, schedule appointments 24/7, automate follow-ups with human-like engagement, and sync data seamlessly with your CRM—saving time, reducing errors, and boosting business growth.</p>
                    </div>
                </motion.div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8 }} className="lg:col-span-7 flex flex-col md:flex-row gap-8 items-center">
                        <div className="relative w-full max-w-[320px] aspect-square rounded-[40px] overflow-hidden flex-shrink-0">
                            <img src={image3} alt="Targeting" className="w-full h-full object-cover" />
                        ...
                        <div className="max-w-xs">
                            ...
                            <p className="text-gray-500 text-sm leading-relaxed">Our AI identifies high-intent prospects, filters unqualified leads, and focuses on those most likely to convert—saving time and boosting results.</p>
                        </div>
                    </motion.div>

                    <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} className="lg:col-span-5 flex items-center gap-2">
                        ...
                        <div className="space-y-6">
                            <div>
                                <h4 className="text-3xl font-semibold leading-none"><AnimatedNumber value={45} />K <span>+</span></h4>
                                <p className="text-gray-400 text-[10px] md:text-xs uppercase tracking-[2px] mt-1 font-semibold">Leads Generation</p>
                            </div>
                            <div className='pl-15'>
                                <h4 className="text-3xl font-semibold leading-none"><AnimatedNumber value={78} />% <span>+</span></h4>
            ...
            <section className="bg-linear-to-br from-white via-cyan-50/30 to-white py-20 px-8 md:px-24 font-sans text-gray-900 min-h-screen flex items-center">
                <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInScroll} className="flex flex-col space-y-10">
                        <div>
                            <h2 className="text-6xl font-normal leading-tight">What We</h2>
                            <h2 className="text-6xl font-bold leading-tight">Automate</h2>
                        </div>
                        <ul className="space-y-4">
                            {['Lead capture & qualification', '24/7 appointment scheduling', 'Automated follow-ups', 'Instant property inquiries','CRM & pipeline updates'].map((item, index) => (
                                <motion.li initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: index * 0.1 }} key={index} className="flex items-center text-2xl font-medium text-gray-800">
                    ...
                    <motion.div initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 1 }} className="relative">
                        ...
                        <div className="rounded-[60px] overflow-hidden shadow-2xl mt-5">
                            <img src={image5} alt="AI Robot" className="w-full h-auto object-cover aspect-[4/3] hover:scale-105 transition-transform duration-700" />
                        </div>
                    </motion.div>
                </div>
            </section>

            {/* Video / Outcomes Section */}
            <section className="bg-linear-to-br from-white via-cyan-50/30 to-white py-20 px-8 md:px-24 font-sans text-gray-900">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="relative overflow-hidden rounded-[60px] shadow-xl aspect-square lg:aspect-auto lg:h-[600px]">
                        <video autoPlay muted loop playsInline className="w-full h-full object-cover">
                            <source src={AgentClientVideo} type="video/mp4" />
                        </video>
                    </motion.div>
                    
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInScroll} className="flex flex-col space-y-8">
                        <div>
                            <h2 className="text-5xl font-light leading-tight">Outcomes of</h2>
                            <h2 className="text-5xl font-bold leading-tight">Automation</h2>
                        </div>
                        <p className="text-gray-500 max-w-md leading-relaxed">Automation boosts efficiency, increases lead conversion, and enhances client engagement—saving time and driving measurable growth.</p>
                        <div className="flex flex-wrap gap-3">
                            {['Automated Call', 'Voice Agent', 'Automated SMS'].map(item => (
                                <button key={item} className="px-6 py-2 border border-gray-300 hover:bg-blue-600 hover:text-white rounded-full text-sm transition-all shadow-md">{item}</button>
                            ))}
                        </div>
                        <div className="pt-6 flex flex-col space-y-4">
                            <div className="flex items-center">
                                ...
                                <div className="ml-6">
                                    <span className="text-3xl font-semibold block"><AnimatedNumber value={15392} />+</span>
                                </div>
                            </div>
            ...
            {/* CTA Section */}
            <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1 }} className="bg-linear-to-br from-white via-cyan-50/30 to-white py-24 px-8 md:px-24 font-sans text-gray-900 flex flex-col items-center text-center">
