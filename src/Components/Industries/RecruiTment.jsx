...
import image1 from '../../assets/Recruitment/2.png';
import image2 from '../../assets//Recruitment/3.png';
...
import AgentClientVideo from '../../assets/Recruitment/1.mp4';
                            ...
                            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="lg:col-span-6 flex flex-col min-h-[85vh] justify-between">
                                <div className="space-y-10">
                                    <div className="space-y-1">
                                        ...
                                        <h1 className="text-6xl md:text-6xl font-bold text-[#3B82F6] tracking-tight">Recruitment</h1>
                                    </div>
                                ...
                                <div className="mt-32 flex flex-col md:flex-row md:items-end gap-12 mb-8">
                                    ...
                                    <div className="flex flex-col gap-5 md:max-w-sm">
                                        ...
                                        <p className="text-gray-500 text-base leading-relaxed">Recruitment firms must manage both clients and candidates efficiently. Automation speeds up hiring cycles and improves placement rates.</p>
                                    </div>
                                </div>
                            </motion.div>
                    ...
                    <section className="bg-white py-16 px-8 md:px-24 font-sans text-gray-900 overflow-hidden">
                        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="flex flex-col md:flex-row justify-between items-start mb-16">
                            ...
                            <div className="mt-8 md:mt-0 max-w-md">
                                ...
                                <p className="text-gray-500 leading-relaxed">Delayed candidate screening, Missed employer inquiries, Manual resume filtering, Poor interview scheduling, Disorganized communication</p>
                            </div>
                        </motion.div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                            <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8 }} className="lg:col-span-7 flex flex-col md:flex-row gap-8 items-center">
                                ...
                                <div className="max-w-xs">
                                    ...
                                    <p className="text-gray-500 text-sm leading-relaxed">We match candidates and employers based on skills, experience, and hiring urgency.</p>
                                </div>
                            </motion.div>
                        ...
                        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            <div className="flex flex-col space-y-10">
                                ...
                                <ul className="space-y-4">
                                    {['Candidate screening workflows', 'Interview scheduling', 'Employer follow-ups', 'Database management', 'Placement tracking'].map((item, index) => (
                    ...
                    <section className="bg-linear-to-br from-white via-cyan-50/30 to-white py-20 px-8 md:px-24 font-sans text-gray-900">
                        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            ...
                            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="flex flex-col space-y-8">
                                ...
                                <p className="text-gray-500 max-w-md leading-relaxed">Faster placements, improved client satisfaction, and scalable recruitment operations.</p>
