    ...
    return (
        <section>
            ...
            <div className="min-h-screen bg-linear-to-br from-white via-cyan-50/30 to-white p-8 md:p-16 font-sans overflow-hidden mt-15">
                ...
                >
                    <div className="lg:col-span-6 flex flex-col min-h-[85vh] justify-between">
                        <div className="space-y-10">
                            <motion.div variants={fadeInUp} className="space-y-1">
                                ...
                                <h1 className="text-6xl md:text-6xl font-bold text-[#3B82F6] tracking-tight">Real Estate</h1>
                            </motion.div>

                            <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-5 py-2.5 border border-gray-200 rounded-full text-gray-500 bg-white shadow-sm">
                                <PiRainbowThin />
                    ...
                    <motion.div 
                        ...
                        className="lg:col-span-6 relative flex items-start justify-center lg:justify-end gap-2 pt-10"
                    >
                        <div className="relative mt-44"> 
                            <div className="absolute -top-36 left-0 flex flex-col items-end gap-3 z-20 w-full">
                                ...
                                <div className="flex gap-2">
                                    <div className="bg-white hover:bg-blue-600 hover:text-white border border-gray-100 px-5 py-2.5 rounded-full text-[13px] font-medium text-gray-600 shadow-md">Fully cust</div>
                                    <div className="bg-white hover:bg-blue-600 hover:text-white px-5 py-2.5 rounded-full text-[13px] font-medium text-gray-600 shadow-md">Client Onboard</div>
                                </div>
                            </div>
                            <img src={image2} alt="Professional" className="w-80 md:h-[480px] relative z-10 object-cover rounded-2xl" />
                        </div>
                        <div className="relative">
                            <img src={image1} alt="Agent" className="w-80 md:h-[600px] object-cover rounded-2xl" />
                        </div>
                    </motion.div>
                </motion.div>
            </div>
            ...
            <motion.section 
                ...
                variants={staggerContainer}
                className="bg-white py-16 px-8 md:px-24 font-sans text-gray-900"
            >
                <div className="flex flex-col md:flex-row justify-between items-start mb-16">
                    ...
                    <motion.div variants={fadeInUp} className="mt-8 md:mt-0 max-w-md">
                        <div className="flex flex-wrap gap-3 mb-6">
                            {['Leads', 'Client Follow-up', 'Schedule'].map(tag => (
                                <button key={tag} className="px-6 py-2 hover:bg-blue-600 border border-gray-300 hover:text-white rounded-full text-sm transition">{tag}</button>
                            ))}
                        </div>
                        <p className="text-gray-500 leading-relaxed">We capture and qualify leads, schedule appointments 24/7, automate follow-ups with human-like engagement, and sync data seamlessly with your CRM.</p>
                    </motion.div>
                </div>

                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    <motion.div variants={fadeInUp} className="lg:col-span-7 flex flex-col md:flex-row gap-8 items-center">
                        <div className="relative w-full max-w-[320px] aspect-square rounded-[40px] overflow-hidden flex-shrink-0 group">
                            <img src={image3} alt="Targeting" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                        ...
                        <div className="max-w-xs">
                            ...
                            <p className="text-gray-500 text-sm leading-relaxed">Our AI identifies high-intent prospects, filters unqualified leads, and focuses on those most likely to convert.</p>
                        </div>
                    </motion.div>

                    <motion.div variants={fadeInUp} className="lg:col-span-5 flex items-center gap-2">
                        ...
                        <div className="space-y-6">
                            {[
                                { val: "45K +", label: "Leads Generation" },
                                { val: "78% +", label: "Conversion Rate" },
                                { val: "24/7", label: "Client Support" }
                            ].map((stat, i) => (
                                <div key={i} className={i === 1 ? "pl-15" : ""}>
                                    <h4 className="text-3xl font-semibold leading-none">{stat.val}</h4>
                                    <p className="text-gray-400 text-[10px] md:text-xs uppercase tracking-[2px] mt-1 font-semibold">{stat.label}</p>
                                </div>
                            ))}
                        </div>
                    </motion.div>
            ...
            {/* --- SECTION 3: AUTOMATE (Scroll Reveal) --- */}
                ...
                <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="rounded-[60px] overflow-hidden shadow-2xl mt-5">
                            <img src={image5} alt="AI Robot" className="w-full h-auto object-cover aspect-[4/3]" />
                        </div>
                    </motion.div>
                </div>
            </section>

            {/* --- SECTION 4: OUTCOMES (Video + Stats) --- */}
            <section className="bg-linear-to-br from-white via-cyan-50/30 to-white py-20 px-8 md:px-24 font-sans text-gray-900">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <motion.div 
                        ...
                        whileInView={{ opacity: 1, scale: 1 }}
                        transition={{ duration: 0.8 }}
                        className="relative overflow-hidden rounded-[60px] shadow-xl aspect-square lg:aspect-auto lg:h-[600px]"
                    >
                    ...
                    >
                        ...
                        <motion.p variants={fadeInUp} className="text-gray-500 max-w-md leading-relaxed">
                        ...
                        <motion.div variants={fadeInUp} className="pt-6 flex flex-col space-y-4">
            ...
            <motion.section 
                ...
                className="bg-linear-to-br from-white via-cyan-50/30 to-white py-24 px-8 md:px-24 font-sans text-gray-900 flex flex-col items-center text-center"
            >
                <motion.div 
