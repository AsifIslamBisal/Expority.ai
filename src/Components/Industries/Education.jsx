...
import AgentClientVideo from '../../assets/Education/3.mp4';
                            ...
                            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="lg:col-span-6 flex flex-col min-h-[85vh] justify-between">
                                <div className="space-y-10">
                                    <div className="space-y-1">
                                        ...
                                        <h1 className="text-6xl md:text-6xl font-bold text-[#3B82F6] tracking-tight">Education</h1>
                                    </div>
                                ...
                                <div className="mt-32 flex flex-col md:flex-row md:items-end gap-12 mb-8">
                                    ...
                                    <div className="flex flex-col gap-5 md:max-w-sm">
                                        ...
                                        <p className="text-gray-500 text-base leading-relaxed">Student inquiries come from multiple channels. Automation ensures every prospective student is nurtured until enrollment.</p>
                                    </div>
                                </div>
                            </motion.div>
                    ...
                    <section className="bg-white py-16 px-8 md:px-24 font-sans text-gray-900 overflow-hidden">
                        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="flex flex-col md:flex-row justify-between items-start mb-16">
                            ...
                            <div className="mt-8 md:mt-0 max-w-md">
                                ...
                                <p className="text-gray-500 leading-relaxed">Missed admission inquiries, Delayed response to applicants, Manual follow-up tracking, Low enrollment conversion, Disorganized communication</p>
                            </div>
                        </motion.div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                            <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8 }} className="lg:col-span-7 flex flex-col md:flex-row gap-8 items-center">
                                ...
                                <div className="max-w-xs">
                                    ...
                                    <p className="text-gray-500 text-sm leading-relaxed">We filter prospects based on program interest, qualification, and enrollment timeline.</p>
                                </div>
                            </motion.div>
                        ...
                        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            <div className="flex flex-col space-y-10">
                                ...
                                <ul className="space-y-4">
                                    {['Inquiry capture', 'Admission follow-ups', 'Counseling appointment booking', 'Document submission tracking', 'Enrollment reporting'].map((item, index) => (
                    ...
                    <section className="bg-linear-to-br from-white via-cyan-50/30 to-white py-20 px-8 md:px-24 font-sans text-gray-900">
                        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            ...
                            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="flex flex-col space-y-8">
                                ...
                                <p className="text-gray-500 max-w-md leading-relaxed">Higher enrollment rates, faster admissions, and improved student engagement.</p>
